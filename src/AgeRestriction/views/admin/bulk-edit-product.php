<?php
/**
 * View for bulk editing products for the age restriction field.
 *
...
<fieldset class="inline-edit-col-right">
	<div class="inline-edit-col">
		...
		<?php do_action( 'oneid_age_restriction_product_bulk_edit_start' ); ?>
		...
		<div class="inline-edit-group wp-clearfix">
			<label class="alignleft">
				...
				<select name="<?php echo esc_attr( AgeRestrictionTaxonomy::TAXONOMY_NAME ); ?>">
					...
					$options = [
						'' => __( '— No change —', 'oneid' ),
						'-1' => __( 'No Age Restrictions', 'oneid' ),
					];
		...
		<?php do_action( 'oneid_age_restriction_product_bulk_edit_end' ); ?>

		<input type="hidden" name="oneid_bulk_edit" value="1" />
		<input type="hidden" name="oneid_bulk_edit_nonce" value="<?php echo esc_attr( wp_create_nonce( 'oneid_bulk_edit_nonce' ) ); ?>" />
	</div>
</fieldset>
