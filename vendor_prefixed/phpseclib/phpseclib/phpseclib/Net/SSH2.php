 ...
 */
namespace OneId_Vendor\phpseclib\Net;

use OneId_Vendor\phpseclib\Crypt\Base;
use OneId_Vendor\phpseclib\Crypt\Blowfish;
use OneId_Vendor\phpseclib\Crypt\Hash;
use OneId_Vendor\phpseclib\Crypt\Random;
use OneId_Vendor\phpseclib\Crypt\RC4;
use OneId_Vendor\phpseclib\Crypt\Rijndael;
use OneId_Vendor\phpseclib\Crypt\RSA;
use OneId_Vendor\phpseclib\Crypt\TripleDES;
use OneId_Vendor\phpseclib\Crypt\Twofish;
use OneId_Vendor\phpseclib\Math\BigInteger;
// Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use OneId_Vendor\phpseclib\System\SSH\Agent;
/**#@+
 * @access private
 */
/**
...
class SSH2
{
    ...
    function _key_exchange($kexinit_payload_server = \false)
    {
        ...
        $compression_map = array('none' => NET_SSH2_COMPRESSION_NONE, 'zlib' => NET_SSH2_COMPRESSION_ZLIB, 'zlib@openssh.com' => NET_SSH2_COMPRESSION_ZLIB_AT_OPENSSH);
    ...
    {
        $this->_connect();
        $compression_map = array(NET_SSH2_COMPRESSION_NONE => 'none', NET_SSH2_COMPRESSION_ZLIB => 'zlib', NET_SSH2_COMPRESSION_ZLIB_AT_OPENSSH => 'zlib@openssh.com');
